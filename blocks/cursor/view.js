...
/* harmony import */ var motion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! motion */ "./node_modules/motion/dist/es/framer-motion/dist/es/frameloop/frame.mjs");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const splitCursor = splitting__WEBPACK_IMPORTED_MODULE_0___default()({
    target: cursor,
    by: 'chars',
    whitespace: true
  });
  ...
  function springToPointer() {
    (0,motion__WEBPACK_IMPORTED_MODULE_2__.animate)(cursor, {
      x: pointerX - initialX,
      y: pointerY - initialY
    }, {
      type: "spring",
  ...
  document.addEventListener("pointermove", e => {
     ...
     */
    motion__WEBPACK_IMPORTED_MODULE_3__.frame.postRender(springToPointer);
  });
  ...
  const hoverTargets = ['wp-block-navigation__responsive-container-close', 'wp-block-navigation__responsive-container-open', 'wp-block-details summary', 'wp-block-navigation-item__label', 'button'];
