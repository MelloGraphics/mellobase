...
function global_theme_styles() {
	...
	wp_enqueue_style( 'mellobase-global-theme-style', get_template_directory_uri() . '/css/global.css', array(), $css_version );
}
...
function front_end_scripts() {
	...
	wp_enqueue_script( 'mellobase-front-end-scripts', get_template_directory_uri() . '/js/scripts.js', $dependencies, $asset_file['version'], true );
}
...
function enqueue_editor_modifications() {
	...
	wp_enqueue_script( 'mellobase-editor-modifications', get_template_directory_uri() . '/js/editor.js', $dependencies, $asset_file['version'], true );
}
